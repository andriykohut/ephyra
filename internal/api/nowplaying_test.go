...
func (s stubClient) PersonImage(context.Context, string) (io.ReadCloser, string, error) {
	return s.personImg()
}
func (s stubClient) UserImage(context.Context, string) (io.ReadCloser, string, error) {
	return s.userImg()
}
